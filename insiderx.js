...
exports.myhandler = async function(event, context){
    var res1 = await client.query("SELECT request_id FROM shuffle_drugs where insiderx_flag = 'pending' and region = '"+reg+"'");
        ...
        if(drugUrlList.rows.length > 0 ){
            ...
            try
            {
                ...
                await rp(options).then(async function(response){
                    ...
                    var query3 = 'UPDATE shuffle_drugs SET insiderx_flag = \'completed\' WHERE request_id = $1';
                    values = [DrugId];
