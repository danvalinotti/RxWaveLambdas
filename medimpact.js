...
exports.myhandler = async function (event, context){
    var res1 = await client.query("SELECT request_id FROM shuffle_drugs where medimpact_flag = 'pending' and region = '"+reg+"'");
        ...
        if(drugUrlList.rows != 0){
            ...
            await rp(url)
                .then(async function (response) {
                    ...
                    var query3 = 'UPDATE shuffle_drugs SET medimpact_flag = \'completed\' WHERE request_id = $1';
                    values = [DrugId];
